<template>
  <div class="w-full flex justify-center">
    <div class="w-full lg:w-11/12 max-w-screen-xl">
        ...
        <div class="col-span-11 md:col-span-9 border-l-2  py-5 border-gray-300 bg-gray-100 dark:bg-[#212121] transition duration-500">
          ...
          <div class="py-5">
            ...
            <div  class="relative grid w-[92%] sm:w-[94%] h-80 sm:h-52 md:h-40 lg:h-48 mt-9 md:mt-0 xl:h-56 max-h-80 mx-3 xs:mx-5 md:mx-10 rounded-md overflow-hidden bg-black cursor-pointer shadow-2xl">
              <div class="w-full h-full transition duration-300 ease-in-out text-gray-400 absolute z-10 hover:text-white">
                <div class="absolute w-full h-[70%] sm:h-full bottom-0 p-3 sm:p-4 md:p-6 sm:w-[80%] rounded-md bg-opacity-50 sm:bg-opacity-0 backdrop-filter sm:backdrop-filter-none backdrop-blur-lg sm:backdrop-blur-none">
                  <h1 class="timeline-title text-md lg:text-xl xl:text-3xl">«Кыргызтест»: Февралдагы тест жүргүзүү</h1>
                  <p class="text-gray-300 text-xs lg:text-sm ">
                    kalys Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iusto accusantium, nisi vel laborum dolorum facere illo quas voluptate harum exercitationem! psum dolor sit, amet consectetur adipisicing elit. Iusto accusantium, nisi vel laborum dolorum facere illo quas voluptate harum exercitationem!
                  </p>
                </div>
              ...
              <div class="overflow-hidden w-full h-1/2 sm:h-full sm:w-1/2 z-0 absolute sm:right-0">
                <img class="object-cover w-full sm:h-full" src="http://kyrgyztest.gov.kg/wp-content/uploads/2022/02/25.02.2022-КР-Эсептөө-палатасы-28_result-scaled.jpg" alt="">
              </div>
              <div class="absolute w-full sm:w-1/2 h-1/2 sm:h-full sm:right-0 bg-gradient-to-t from-black sm:bg-gradient-to-r sm:from-black"></div>
            </div>
          </div>
          ...
          <div class="py-5">
            ...
            <div  class="relative grid w-[92%] sm:w-[94%] h-80 sm:h-52 md:h-40 lg:h-48 mt-9 md:mt-0 xl:h-56 max-h-80 mx-3 xs:mx-5 md:mx-10 rounded-md overflow-hidden bg-black cursor-pointer shadow-2xl">
              <div class="w-full h-full transition duration-300 ease-in-out text-gray-400 absolute z-10 hover:text-white">
                <div class="absolute w-full h-[70%] sm:h-full bottom-0 p-3 sm:p-4 md:p-6 sm:w-[80%] rounded-md bg-opacity-50 sm:bg-opacity-0 backdrop-filter sm:backdrop-filter-none backdrop-blur-lg sm:backdrop-blur-none">
                  <h1 class="timeline-title text-md lg:text-xl xl:text-3xl">«КЫРГЫЗТЕСТ» №61 МЕКТЕП-ЛИЦЕЙИНДЕ</h1>
                  <p class="text-gray-300 text-xs lg:text-sm ">
                    kalys Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iusto accusantium, nisi vel laborum dolorum facere illo quas voluptate harum exercitationem! psum dolor sit, amet consectetur adipisicing elit. Iusto accusantium, nisi vel laborum dolorum facere illo quas voluptate harum exercitationem!
                  </p>
                </div>
              ...
              <div class="overflow-hidden w-full h-1/2 sm:h-full sm:w-1/2 z-0 absolute sm:right-0">
                <img class="object-cover w-full sm:h-full" src="http://kyrgyztest.gov.kg/wp-content/uploads/2022/01/5-960x720.jpg" alt="">
              </div>
              <div class="absolute w-full sm:w-1/2 h-1/2 sm:h-full sm:right-0 bg-gradient-to-t from-black sm:bg-gradient-to-r sm:from-black"></div>
            </div>
          </div>
          ...
          <div class="py-5">
            ...
            <div  class="relative grid w-[92%] sm:w-[94%] h-80 sm:h-52 md:h-40 lg:h-48 mt-9 md:mt-0 xl:h-56 max-h-80 mx-3 xs:mx-5 md:mx-10 rounded-md overflow-hidden bg-black cursor-pointer shadow-2xl">
              <div class="w-full h-full transition duration-300 ease-in-out text-gray-400 absolute z-10 hover:text-white">
                <div class="absolute w-full h-[70%] sm:h-full bottom-0 p-3 sm:p-4 md:p-6 sm:w-[80%] rounded-md bg-opacity-50 sm:bg-opacity-0 backdrop-filter sm:backdrop-filter-none backdrop-blur-lg sm:backdrop-blur-none">
                  <h1 class="timeline-title text-md lg:text-xl xl:text-3xl">КЫРГЫЗТЕСТ»: БҮТҮРҮҮЧҮЛӨР ТЕСТ ТАПШЫРА БАШТАШТЫ</h1>
                  <p class="text-gray-300 text-xs lg:text-sm ">
                    kalys Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iusto accusantium, nisi vel laborum dolorum facere illo quas voluptate harum exercitationem! psum dolor sit, amet consectetur adipisicing elit. Iusto accusantium, nisi vel laborum dolorum facere illo quas voluptate harum exercitationem!
                  </p>
                </div>
              ...
              <div class="overflow-hidden w-full h-1/2 sm:h-full sm:w-1/2 z-0 absolute sm:right-0">
                <img class="object-cover w-full sm:h-full" src="http://kyrgyztest.gov.kg/wp-content/uploads/2022/03/MG_0800_result-1-1280x720.jpg" alt="">
              </div>
              <div class="absolute w-full sm:w-1/2 h-1/2 sm:h-full sm:right-0 bg-gradient-to-t from-black sm:bg-gradient-to-r sm:from-black"></div>
            </div>
          </div>
          ...
          <div class="sticky top-0 z-10 bg-white w-full py-5">
            <span>Дасыгын жогорулатуу курстары:</span>
          </div>
          <div class="py-5">
            <div class="w-5 h-5 rounded-full absolute -ml-3 bg-black flex justify-center items-center border-2 border-white">
              <div class="absolute">
              ...
              <span class="absolute -ml-36 text-gray-300">13 Dec 2021</span>
            </div>
            <div class="mx-5">
              <h1>2021-ЖЫЛДЫН МЫКТЫ МАМЛЕКЕТТИК МЕКЕМЕСИ</h1>
              <p>
                kalys Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iusto accusantium, nisi vel laborum dolorum facere illo quas voluptate harum exercitationem! psum dolor sit, amet consectetur adipisicing elit. Iusto accusantium, nisi vel laborum dolorum facere illo quas voluptate harum exercitationem!
              </p>
            </div>
